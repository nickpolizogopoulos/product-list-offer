...
export const contentKr: AboutContent = {
    ...
    appDescription: `
        ...
        기업이 간단히 양식을 작성하는 것만으로 상세한 제품 제안 pdf 를 몇 분 만에 생성할 수 있도록 합니다. 
    ...
    features: [
        {
            name: '동적 맞춤화',
            information: `회사는 자신의 정보와 고객 또는 클라이언트의 정보를 입력하고, 제안을 맞춤화하여 개인화된 pdf 를 생성할 수 있습니다.`
        },
        {
            name: '시간 절약 기능',
        ...
        },
        {
            ...
            information: `
                pdf 에 색상 세부 정보를 포함할지 여부를 선택할 수 있습니다.
