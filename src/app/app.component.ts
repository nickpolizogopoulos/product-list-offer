      ...
      <section class="container">
        ...
        @if (logo) {
          <section class="slider-switch">
            ...
            <mat-slide-toggle (click)="toggleLogoVisibility()">
...
export class AppComponent implements OnInit {
  ...
  form = new FormGroup({
    companyName: new FormControl(initialCompanyNameValue, Validators.required),
    logoLink: new FormControl(initialCompanyLogoLinkValue),
    logoWidth: new FormControl(initialLogoWidthValue),
    companyPhone: new FormControl(initialCompanyPhoneValue, Validators.required),
    companyEmail: new FormControl(initialCompanyEmailValue, { validators: [Validators.required, mustContainPeriod]}),
    companyLocation: new FormControl(initialCompanyLocationValue, Validators.required),
  ...
  onSubmit(): void {
    ...
    console.log('logo width: ' + this.form.controls.logoWidth.value);
