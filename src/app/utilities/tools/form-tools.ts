...
//* value = control.value; stoires the control's value.
//* typeof value === 'string' && value.includes('.') checks if it contains period.
...
export let initialLogoWidthValue: number = 125;
